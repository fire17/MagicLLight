...
```bash
pip install magicllight
```
run: magiclligt      

	  
embed: <--MagicLLight Link-->
```
...
Works with: 
✰ Ruby.ai <> @ openai <> ● open-interpreter <> 火 Akyeo <> 🧠 Claude2 <> 🦜 Langchain <> 🎙 ElevenLabs
...
Plans & Pricing:
  Dev/Hobbiest: Freely use forever, bring your own models
  For Personal Use: use your openai/claude/ruby api key, or choose one of the our models (10-30$ month or pay as you go)
  Premium User: All features out of the box, private files, multimodel, agents & much more (read here)
  Small Business: Use your own branding, private knowledge on your site (Embed), 
  Entreprise: Commercial License Can be recived from us based on approval
  
    
To join our Private Beta and be first to test the cutting edge:
Click here
...
Coming soon:
 ...
 - Grandma Mode: Work alongside technologically challenged/inexperienced users
	* Press Capslock for live voice chat mode
